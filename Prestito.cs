...
public class Prestito
{
    ...
    public int ImportoPrestito { get; set; }
    public int RataPrestito { get; set; }
    public DateOnly Inizio { get; set; }
    public DateOnly Fine { get; set; }

    public static int Conteggio = 0;

    public Prestito(Cliente cliente, int importoPrestito, int rataPrestito, DateOnly inizio, DateOnly fine)
    {
        Conteggio++;
        Id = Conteggio;
        Cliente = cliente;
        this.ImportoPrestito = importoPrestito;
        this.RataPrestito= rataPrestito;
        Inizio = inizio;
        Fine = fine;
    }
}